...
if __name__ == '__main__':
    ...
    MIN_DECK = 10
    curve_by_faction = all_cards[all_cards.Type != 'Power'].groupby(['DeckMainFaction', 'Cost'])['Name'].count().unstack(1)
    ...
    sorted_units_faction_by_health = units_health_by_faction.ix[units_health_by_faction.sum(axis=1).sort_values(ascending=False).index].transpose()
    ...
    for i, COST in enumerate([3, 5]):
        ...
        sorted_stealth_units_faction_by_health = stealth_units_health_by_faction.ix[
